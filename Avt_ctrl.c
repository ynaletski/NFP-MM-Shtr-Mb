...
///yyy//////////////////////////////////////////////////
int num_in16 = 2;    //  консоль в горловине CN_IN_THR
///////////////////////////////////////////////////////
//04.02.2020 YN -----\\//-----
int num_in17 = 0;    //  концевик отсечного клапана
//04.02.2020 YN -----//\\-----
...
int itmp=0;
   ...
   ///yyy//////////////////////////////////////следующая строка была закоментирована и в скобках было пусто
   if(CN_IN_THR ) itmp |=0x40; //D6   - консоль в горловине
   ////////////////////////////////////////////
   ...
   if(STOP_IN ) itmp |=0x1000; //D12  - кнопка "Stop" верхнего налива       1 - кнопка нажата
   if(STOP_IN_L) itmp |=0x2000; //D13 - кнопка "Stop" нижнего налива        1 - кнопка нажата
   //04.02.2020 YN -----\\//-----
   if(CUT_SW_CL) itmp |=0x4000; //D14 - отсечной клапан закрыт        
   //04.02.2020 YN -----//\\-----
...
///yyy///////////////////////////////////////////////////////////////////
    if( (CN_IN_THR)==0 )
    {
       flagE_UZA=CN_THR_E;
       f_icp_errS(UZA_off);
//     MmiGotoxy(0,1);    MmiPuts("    Консоль не в горловине!!! ");
   ...
   //case 21:
    ...
    else if(key==ESC)
    {
     ...
     f_reg_cmn(10);
      ...
      MmiGotoxy(0,1); MmiPuts("Ожидание открытия отс.клапана ");
      time_t_swtch=TimeStamp;
      flag_continue=0;
      break;
    }
