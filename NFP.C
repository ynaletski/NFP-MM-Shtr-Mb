...
/////qqq///////////////////////////////////
#if defined(Press_mb)
	if(Pr_mb[0].status)  f_Pr_mb(0);
#endif
////////////////////////////////////////////

/////www///////////////////////////////////
#if defined(Press_415m)
	if(Pr_415m[0].status)  f_Pr_415m(0);
#endif
////////////////////////////////////////////

///rrr///////////////////////////////////////////
  #if defined(Temp_tpu)
    if(Temp_TPU[0].status) f_Temp_tpu(0);
   #endif
//////////////////////////////////////////////////
...
union  { float f; char c[4]; } o;
 ...
 if(flag_pool)
 {
  ...
  //23.01.2020 YN  -----\\//-----
  Temp_sum_YN=Temp_sum_YN+( s_MVD[0].Temp * ((float) (mas_ch_cur-mas_ch_cur_old)) );
  Press_sum_YN += ( s_MVD[0].Press * ((float) (mas_ch_cur-mas_ch_cur_old)) );
  Dens_sum_YN += ( s_MVD[0].Dens * ((float) (mas_ch_cur-mas_ch_cur_old)) );
