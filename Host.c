...
int i;
  ...
  printf("\n\rNumber  Name      status  port addr CRC_flag pool,ms timeout,ms");
    for(i=0;i<icp_lst_max;i++)
    {
      ICPl_DEV=ICP_dd[i];
...
//---------------------------------//23.03.2020 YN  -----\\//-----
      if (!strcmp(intrpr.wrd,"MDS" ))
        {   //'MDS'
          f_dis_set(ds_mds,3,1);
          f_md5_sent(count_mds);
          goto fin;
        }
//---------------------------------
      if (!strcmp(intrpr.wrd,"SIZE" ))
        {   //'SIZE'
          f_size();
          goto fin;
        }
...
//---------------------------------
        ...
        {   //'DRV'
         if( ((i=f_123(4)) >= 0 ) &&  (i< icp_lst_max ) )
         {
          ...
          ///qqq1/////www1//////////////////////////
           if((Pr_mb[0].status) && (Pr_415m[0].status))
                  printf("\n\r> Warning! Both pressure is On! \n\r>");    
          /////////////////////////////////////////
          goto fin;
         }
        }
...
//---------------------------------
  ...
  {
     ///qqq/////www///////////////////////////////////
      #if !defined(Press_mb) && !defined(Press_415m)
     ...
     ///qqq1/////www1/////////////////////////////////
      #if defined(Press_mb) && defined(Press_415m)
                  if((Pr_mb[0].status == 0 ) && (Pr_415m[0].status == 0 ))
                  {
                    s_MVD[0].Press= analog_offset[0];
                  }
      #endif
