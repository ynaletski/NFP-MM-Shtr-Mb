...
///now:
#if defined(Temp_tpu)
&Temp_TPU[0].status         ,sizeof(Temp_TPU[0].status        ),
&Temp_TPU[0].addr           ,sizeof(Temp_TPU[0].addr          ),
#else
&fict_ftmp,sizeof( fict_ftmp ),
#endif
//////////////////////////////////////////////////////////////////////
...
///now:
#if defined(Press_mb)
&Pr_mb[0].status         ,sizeof(Pr_mb[0].status        ),
&Pr_mb[0].addr           ,sizeof(Pr_mb[0].addr          ),
#else
&fict_ftmp,sizeof( fict_ftmp ),
#endif
//////////////////////////////////////////////////////////////////////
...
&Pr_415m[0].status         ,sizeof(Pr_415m[0].status        ),
&Pr_415m[0].addr           ,sizeof(Pr_415m[0].addr          ),
#else
&fict_ftmp,sizeof( fict_ftmp ),
#endif
//////////////////////////////////////////////////////////////////////
...
&fict_ftmp,sizeof( fict_ftmp ),
//04.02.2020 YN  -----\\//-----
//was:&fict_ftmp,sizeof( fict_ftmp ),
//now:
&num_in17   ,sizeof(num_in17  ),
&mski_inp17  ,sizeof(mski_inp17  ),
//04.02.2020 YN  -----//\\-----

&fict_ftmp,sizeof( fict_ftmp ),   ///используется под do9 do10 в программе для ТрансЭкспЗапад
